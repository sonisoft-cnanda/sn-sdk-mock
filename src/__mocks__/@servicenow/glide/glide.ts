...
export class MockGlideSystem {
    public static getProperty = jest.fn().mockImplementation((propertyName: string) => {
        return MOCKED_PROPERTIES[propertyName];
    });

    public static setProperty = jest.fn().mockImplementation((propertyName: string, value: string) => {
        MOCKED_PROPERTIES[propertyName] = value;
    });

    public static log = jest.fn().mockImplementation((message: string) => {
        console.log(message);
    });

    public static importXML = jest.fn().mockImplementation((xml: string) => {
        return xml;
    });

    public static getUserName = jest.fn().mockImplementation(() => {
        return 'admin';
    });


    public static getSystemId = jest.fn().mockImplementation(() => {
        return 'admin';
    });
...
export class MockGlideRecord {
   ...
   // private _mockRecords: Record<string, any>[];
    ...
    //TODO - implement this
    get = jest.fn().mockImplementation((sysId: string) => {
    ...
    isNewRecord = jest.fn().mockImplementation(() => {
        return this.isNewRecord;
    });

    addActiveQuery = jest.fn().mockImplementation((...args: any[]) => {
        this._isNewRecord = false;
    ...
    deleteMultiple = jest.fn().mockImplementation(() => {
        return this;
    });
